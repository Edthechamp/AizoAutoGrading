...
Add proper debug checks in get_title and get_answers_box
...
def get_box_answers(image, box, debug=False):
    ...
    #determine how many columns of questions are there
    questions = []
    ...
    for question in questions:
        ...
        if min(means) > 100:
            answers[question_num] = "ABCD"[means.index(min(means))]
